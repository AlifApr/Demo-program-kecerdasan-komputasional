...
def partial_dMF(x, mf_definition, partial_parameter):
    ...
    #menghitung turunan dari fungsi gaussian dengan parameter input :a,b,c
...
ts = numpy.loadtxt("dataBP.txt", usecols=[1,2,3])
X = ts[:,0:2]
Y = ts[:,2]
...
z=predict(anf, np.array([[1.,1.],[2.,4.],[1.,2.],[1.,3.],[3.,4.],[4.,1.],[4.,2.],[4.,3.],[4.,4.],[3.,1.]
                        ]))
z
